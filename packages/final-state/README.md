...
[![minified + gzip](https://badgen.net/bundlephobia/minzip/final-state@2.0.1-alpha.0-alpha.0)](https://bundlephobia.com/result?p=final-state@2.0.1-alpha.0-alpha.0)
