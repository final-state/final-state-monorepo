...
[![minified + gzip](https://badgen.net/bundlephobia/minzip/react-final-state@2.0.1-alpha.0-alpha.0-alpha.1-alpha.1-alpha.1-alpha.1-alpha.0)](https://bundlephobia.com/result?p=react-final-state@2.0.1-alpha.0-alpha.0-alpha.1-alpha.1-alpha.1-alpha.1-alpha.0)
